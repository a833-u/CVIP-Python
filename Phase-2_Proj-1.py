...
class TypeSpeedGUI:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Ansh's Typing Speed Application")
        ...
        self.speed_label.grid(row=15, column=0, columnspan=2, padx=5, pady=10)

        self.reset_button = tk.Button(self.frame, text="Reset", command=self.reset)
        self.reset_button.grid(row=25, column=0, columnspan=2, padx=10, pady=10)
